          ...
          child: Row(
            ...
            children: [
              ...
              DropdownButton<String>(
                ...
                onChanged: (catrgory) {},
                items: [
                  const DropdownMenuItem(value: 'movies', child: Text('Еда')),
                  const DropdownMenuItem(value: 'tv', child: Text('Напитки')),
                  const DropdownMenuItem(value: 'tvShows', child: Text('Еда')),
                ],
              ),
            ],
          ),
